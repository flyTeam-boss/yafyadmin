<template>
    <div class="app-container">
        ...
        <div class="formBox">
                ...
                <div class="dialogBox">
                    <el-form-item  label="考试时长：" label-width="95px">
                        <span>{{form.limitTime}}分钟</span>
                    </el-form-item>
                    <el-form-item label="公开答案：" label-width="95px">
                      <span>{{form.transparent}}</span>
                    </el-form-item>
                </div>
        </div>
        <h3>习题信息 </h3>
        ...
        <el-form-item>
            ...
            ref='roleInfo'
            :key="tableKey"
            :data="form.questionBankResponses"
...
export default {
    ...
    created(){
        ...
        this.$API.specialPractice.limitTimePracticedetailPage(this.$route.query.id).then((res)=>{
            this.form=res.data.object
            this.form.status=this.status[res.data.object.status].name
            this.form.transparent=this.transparentList[res.data.object.transparent].name
            this.form.questionBankResponses.forEach((item)=>{
